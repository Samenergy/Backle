          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                required
                className="block w-full px-4 rounded-md focus:outline-nonNe border-0 py-1.5 text-gray-90 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
